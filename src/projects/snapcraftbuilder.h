#ifndef SNAPCRAFTBUILDER_H
#define SNAPCRAFTBUILDER_H
...
class SnapcraftBuilder : public BuilderBackend
{
    Q_OBJECT
...
public slots:
    ...
    void clean() override;
    void build(const bool debug, const bool aot, const bool exceptions) override;
